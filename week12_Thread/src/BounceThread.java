...
class BounceFrame extends JFrame
{
	...
	public BounceFrame()
	{
		...
		addMenuItem(menu, "Faster", new ActionListener() {
			@Override
		...
		addMenuItem(menu, "Slower", new ActionListener() {
	...
	public void addMenuItem(JMenu menu, String string, ActionListener actionListener) {
